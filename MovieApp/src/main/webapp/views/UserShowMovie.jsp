...
<!-- <iframe src="/views/UserNavbar.html" height="100px " width="100px"></iframe>   -->
							...
							<div class="col ">
								...
								<div class="col" style="margin-right: 5px;">
									...
									<div class="col bor" style="padding:15px 15px 15px 15px">
										<a href="movie/user/cart/add/mid=${movie.mid}">
									    <button class="btn " style="background-color:#77ff4d">Add To Cart</button>
									    </a>
